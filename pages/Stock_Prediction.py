...
from pages.utils.model_train import get_data, get_rolling_mean, get_differencing_order, evaluate_model, scaling, get_forecast, inverse_scaling
import pandas as pd
...
# Minimal stock prediction page to ensure Streamlit multipage detects the page
...
st.subheader('Predicting Next 30 days closing price for '+ ticker) 
